...
export function validateBackup(value){
  ...
  const data=value.data; if(!data||![1,2,3,4,5,6,7,8].includes(data.schemaVersion))errors.push('スキーマバージョンが未対応です');
